...
const CharacterTab = () => {
  ...
  const char = useCharacterStore((state) => state.char);
    ...
    <>
      <div className="space-y-4 shrink-0">
        <div className="space-y-2">
          <label htmlFor="lv" className="flex items-center gap-1">
        ...
        <div className="space-y-2">
          ...
          <div className="flex gap-2 items-center">
            {Object.values(char?.ranks ?? []).map((rank, index) => {
            ...
            <div className="space-y-2">
              ...
              >
                ...
                <InputNumber
                  ...
                  onChange={(val) => {
                    console.log(`val lv lightcone:`, val);
                    updateChar(Number(id), {
                      lightcone: {
              ...
              <label htmlFor="superimpose" className="flex gap-2 items-center">
