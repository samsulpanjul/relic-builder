...
export default function PlanarPiece({ reset, name, relicPc, setRelic, pc, mainStat, setMainStat, upgradePc, children }) {
  return (
    <div className="border-b py-5">
      ...
      <div className="grid grid-cols-5">
        <div className="col-span-2">
          ...
          <ComboboxPlanar data={relic} name={"relic set"} img={true} value={relicPc} setValue={setRelic} />
          ...
          <Combobox data={relic[12].set[pc].mainStat} name={"main stat"} value={mainStat} setValue={setMainStat} />
        </div>
...
function ComboboxPlanar({ data, img = false, name, value, setValue }) {
